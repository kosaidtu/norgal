...
//					sysout.println("Writing short match strings.");
	...
	private final void checkFiles(){
		...
		if(outFileM!=null && outFileM2==null && outFileM.contains("#") && !outFileM.contains(".sam") && !outFileM.contains(".bam") && outFile.contains(".")){
		...
		if(outFileU!=null && outFileU2==null && outFileU.contains("#") && !outFileU.contains(".sam") && !outFileU.contains(".bam") && outFile.contains(".")){
